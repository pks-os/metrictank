...
func (b *MetaRecordIdx) initBare(ctx context.Context) error {
	err := btHelpers.EnsureTableExists(ctx, b.cfg.createCf, b.adminClient, "meta_records", map[string]bigtable.GCPolicy{
	...
	err = btHelpers.EnsureTableExists(ctx, b.cfg.createCf, b.adminClient, "meta_record_batches", map[string]bigtable.GCPolicy{
